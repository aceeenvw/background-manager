...
- **Folders** — create, rename and delete folders; drag-and-drop backgrounds
  ...
  folder, by *Unsorted*, or by *This Chat*. Cards show an **in-folder badge** so you
...
- Drag a card onto a folder (or onto *Unsorted*) to file it.
...
| **Backgrounds per page** | How many backgrounds each page shows: 10 / 30 / 60 / 100. Defaults to 30. |
